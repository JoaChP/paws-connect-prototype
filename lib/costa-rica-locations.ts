...
export const costaRicaLocations: ProvinceOption[] = [
  {
    ...
    cantons: [
      ...
      canton('desamparados', 'Desamparados', 9.8981, -84.0647, ['Desamparados', 'San Miguel', 'San Juan de Dios', 'San Rafael Arriba', 'San Antonio', 'Frailes', 'Patarrá', 'San Cristóbal', 'Rosario', 'Damas', 'San Rafael Abajo', 'Gravilias', 'Los Guido']),
      ...
      canton('goicoechea', 'Goicoechea', 9.9500, -84.0500, ['Guadalupe', 'San Francisco', 'Calle Blancos', 'Mata de Plátano', 'Ipís', 'Rancho Redondo', 'Purral']),
      ...
      canton('vazquez-de-coronado', 'Vázquez de Coronado', 9.9766, -84.0065, ['San Isidro', 'San Rafael', 'Dulce Nombre de Jesús', 'Patalillo', 'Cascajal']),
      ...
      canton('perez-zeledon', 'Pérez Zeledón', 9.3720, -83.7030, ['San Isidro de El General', 'El General', 'Daniel Flores', 'Rivas', 'San Pedro', 'Platanares', 'Pejibaye', 'Cajón', 'Barú', 'Río Nuevo', 'Páramo', 'La Amistad']),
  ...
  },
  {
    ...
    lng: -84.2117,
    cantons: [
      canton('alajuela', 'Alajuela', 10.0162, -84.2117, ['Alajuela', 'San José', 'Carrizal', 'San Antonio', 'Guácima', 'San Isidro', 'Sabanilla', 'San Rafael', 'Río Segundo', 'Desamparados', 'Turrúcares', 'Tambor', 'Garita', 'Sarapiquí']),
      ...
      canton('grecia', 'Grecia', 10.0739, -84.3132, ['Grecia', 'San Isidro', 'San José', 'San Roque', 'Tacares', 'Puente de Piedra', 'Bolívar']),
      ...
      canton('naranjo', 'Naranjo', 10.0987, -84.3868, ['Naranjo', 'San Miguel', 'San José', 'Cirri Sur', 'San Jerónimo', 'San Juan', 'El Rosario', 'Palmitos']),
